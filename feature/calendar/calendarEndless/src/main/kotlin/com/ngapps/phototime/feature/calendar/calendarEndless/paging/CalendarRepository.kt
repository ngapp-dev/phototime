...
/**
 * Represents a Calendar model entity.
 *
 ...
 */
@Immutable
data class CalendarModelEntity(
    val name: String,
...
/**
 * Repository for generating CalendarModelEntity objects and managing date lists.
 */
class CalendarRepository {

    /**
     * Generates a list of [CalendarModelEntity] objects for the specified year.
     *
     * @param year The year for which to generate the [CalendarModelEntity] objects.
     * @return The list of generated [CalendarModelEntity] objects.
     */
    fun generateDates(year: Int = 2023) = Month.values().map { month ->
        val yearMonth = YearMonth.of(year, month)
        val startDate = yearMonth.atDay(1)
        val startDayOfWeek = startDate.dayOfWeek
        val start = getCalendarStartDay(startDayOfWeek)
        ...
        CalendarModelEntity(month.name, dates, yearMonth.month, yearMonth.year)
    }
...
/**
 * Calculates the start day for the Calendar based on the specified day of the week.
 *
 * @param dayOfWeek The day of the week.
 * @return The start day for the Calendar.
 */
private fun getCalendarStartDay(dayOfWeek: DayOfWeek): Int {
