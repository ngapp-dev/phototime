...
package com.ngapps.phototime.feature.calendar.calendarEndless.ui.modifier
...
fun Modifier.circleLayout() =
    layout { measurable, constraints ->
        // NOTE: Measure the composable
        val placeable = measurable.measure(constraints)

        // NOTE: Get the current max dimension to assign width=height
        val currentHeight = placeable.height
        val currentWidth = placeable.width
        val newDiameter = maxOf(currentHeight, currentWidth)

        // NOTE: Assign the dimension and the center position
        layout(newDiameter, newDiameter) {
            // NOTE: Where the composable gets placed
