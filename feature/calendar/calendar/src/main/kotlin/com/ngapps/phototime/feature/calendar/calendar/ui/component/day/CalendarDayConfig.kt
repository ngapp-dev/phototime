...
/**
 * Configuration data class for customizing the appearance of a Calendar day.
 *
 * @param size The size of the Calendar day.
 * @param textSize The text size of the day.
 * @param textColor The text color of the day.
 * @param currentDayTextColor The text color of the selected day.
