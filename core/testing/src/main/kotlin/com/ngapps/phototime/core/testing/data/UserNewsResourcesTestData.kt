...
import com.ngapps.phototime.core.model.data.NewsResourceType.Codelab
import com.ngapps.phototime.core.model.data.NewsResourceType.Unknown
...
val userNewsResourcesTestData: List<UserNewsResource> = UserData(
    ...
    locationCategories = setOf("First category", "Second category"),
    contactCategories = setOf("First category", "Second category"),
    taskCategories = setOf("First category", "Second category"),
).let { userData ->
    listOf(
        UserNewsResource(
