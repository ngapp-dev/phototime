...
/**
 * Photo time view toggle button with included trailing icon as well as compact and expanded
...
fun PtViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = PtViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        PtViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) PtIcons.ViewDay else PtIcons.ShortText,
...
/**
 * Internal Photo time view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun PtViewToggleButtonContent(
...
/**
 * Photo time view toggle default values.
 */
object PtViewToggleDefaults {
    // TODO: File bug
