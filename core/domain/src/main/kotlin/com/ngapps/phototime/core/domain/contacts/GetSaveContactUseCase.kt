...
class GetSaveContactUseCase @Inject constructor(
    private val contactsRepository: ContactsRepository
) {
    suspend operator fun invoke(contact: ContactResourceQuery): DataResult<ResponseResource> =
        contactsRepository.getSaveContact(contact).checkResultAndReturn(
