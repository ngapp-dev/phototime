...
class GetSignUpUseCase @Inject constructor(
    ...
    suspend operator fun invoke(signUpResourceQuery: SignUpResourceQuery): DataResult<ResponseResource> =
        authRepository.getSignUp(signUpResourceQuery).checkResultAndReturn(
