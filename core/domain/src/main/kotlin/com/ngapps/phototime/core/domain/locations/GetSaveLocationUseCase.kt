...
class GetSaveLocationUseCase @Inject constructor(
    private val locationsRepository: LocationsRepository
) {
    suspend operator fun invoke(location: LocationResourceQuery): DataResult<ResponseResource> =
        locationsRepository.getSaveLocation(location).checkResultAndReturn(
