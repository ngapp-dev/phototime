...
package com.ngapps.phototime.core.domain.auth
...
class GetGoogleSignInUseCase @Inject constructor(
    ...
    suspend operator fun invoke(googleSignInResourceQuery: GoogleSignInResourceQuery): DataResult<AuthResource> =
        authRepository.getGoogleSignIn(googleSignInResourceQuery).checkResultAndReturn(
            onSuccess = {
                authRepository.saveTokens(it)
