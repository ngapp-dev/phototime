 ...
 * provides list of [ShootResource] for Composable previews.
 */
class ShootResourcePreviewParameterProvider : PreviewParameterProvider<List<ShootResource>> {

    override val values: Sequence<List<ShootResource>> = sequenceOf(shootResources)
}

object PreviewParameterShootData {

    val shootResources = listOf(
        ShootResource(
            id = "1",
