 ...
 * provides list of [LocationResource] for Composable previews.
 */
class LocationResourcePreviewParameterProvider :
    PreviewParameterProvider<List<LocationResource>> {

    override val values: Sequence<List<LocationResource>> = sequenceOf(locationResources)
}

object PreviewParameterLocationData {

    val locationResources = listOf(
        LocationResource(
            id = "1",
            category = "Nature",
            title = "Sunny Meadows",
