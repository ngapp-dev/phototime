 ...
 * provides list of [TaskResource] for Composable previews.
 */
class TaskResourcePreviewParameterProvider : PreviewParameterProvider<List<TaskResource>> {

    override val values: Sequence<List<TaskResource>> = sequenceOf(taskResources)
}

object PreviewParameterTaskData {

    val taskResources = listOf(
        TaskResource(
            id = "1",
