...
suspend fun Synchronizer.changeListSync(
    ...
    // NOTE: Fetch the change list since last sync (akin to a git fetch)
    ...
    // NOTE: Delete models that have been deleted server-side
    modelDeleter(deleted.map(NetworkChangeList::id))

    // NOTE: Using the change list, pull down and save the changes (akin to a git pull)
    modelUpdater(updated.map(NetworkChangeList::id))

    // NOTE: Update the last synced version (akin to updating local git HEAD)
