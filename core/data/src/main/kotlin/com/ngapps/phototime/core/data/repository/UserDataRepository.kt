...
interface UserDataRepository {
     ...
     */
    suspend fun setUserLocation(userLocation: Pair<String, String>)

    /**
     * Updates the completed status for a task resource
     */
    suspend fun updateTaskResourceCompleted(taskResourceId: String, completed: Boolean)
