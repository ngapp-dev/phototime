...
interface AuthRepository {
    ...
    suspend fun getSignIn(query: SignInResourceQuery): DataResult<AuthResource>

    suspend fun getGoogleSignIn(query: GoogleSignInResourceQuery): DataResult<AuthResource>

    suspend fun getSignUp(query: SignUpResourceQuery): DataResult<ResponseResource>

    suspend fun getSignOut()

    fun saveTokens(authResource: AuthResource)
