...
/**
 * Data layer implementation for [UserTaskResource]
 */
interface ShootWithTasksResourceRepository {
    /**
     * Returns available shoot with tasks resources as a stream.
     */
    fun observeShootResourcesWithTasks(
