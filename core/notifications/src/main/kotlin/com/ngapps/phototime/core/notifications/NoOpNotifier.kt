...
class NoOpNotifier @Inject constructor() : Notifier {
    override fun postTaskNotifications(taskResources: List<TaskResource>) = Unit
    override fun postLocationNotifications(locationResources: List<LocationResource>) = Unit
    override fun postContactNotifications(contactResources: List<ContactResource>) = Unit
    override fun postShootNotifications(shootResources: List<ShootResource>) = Unit
    override fun postMoodboardNotifications(moodboardResources: List<MoodboardResource>) = Unit
    override fun postUserNotifications(userResource: UserResource) = Unit
}
