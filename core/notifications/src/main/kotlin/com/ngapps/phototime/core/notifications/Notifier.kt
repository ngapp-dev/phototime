 ...
 */
interface Notifier {
    fun postTaskNotifications(taskResources: List<TaskResource>)
    fun postLocationNotifications(locationResources: List<LocationResource>)
    fun postContactNotifications(contactResources: List<ContactResource>)
    fun postShootNotifications(shootResources: List<ShootResource>)
    fun postMoodboardNotifications(moodboardResources: List<MoodboardResource>)
    fun postUserNotifications(userResource: UserResource)
}
