...
import com.ngapps.phototime.MainActivity
...
class NavigationTest {
    ...
    private val navigateUp by composeTestRule.stringResource(HomeR.string.navigate_up)
    private val locations by composeTestRule.stringResource(LocationsR.string.locations)
    private val contacts by composeTestRule.stringResource(ContactsR.string.contacts)
    private val home by composeTestRule.stringResource(HomeR.string.home)
    private val tasks by composeTestRule.stringResource(TasksR.string.tasks)
    private val notes by composeTestRule.stringResource(NotesR.string.notes)
